...
test_cfg = dict(
    rpn=dict(
        ...
        min_bbox_size=0),
    rcnn=dict(
        score_thr=0.001, nms=dict(type='soft_nms', iou_thr=0.5, min_score=0.001), max_per_img=80))
# dataset settings
...
log_level = 'INFO'
work_dir = './undersonar/work_dirs/all_cascade_r101/'     
# load_from = None         
load_from = "./checkpoints/cascade_rcnn_dconv_c3-c5_r101_fpn_1x_20190125-aaa877cc.pth"
resume_from = None 
workflow = [('train', 1)]
